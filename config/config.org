...
Font Settings:
#+begin_src emacs-lisp
(set-frame-font "DroidSansMNerdFontMono-14" nil t)
(set-face-attribute 'default nil :font "DroidSansMNerdFontMono-14")
(set-face-attribute 'fixed-pitch nil :font "DroidSansMNerdFontMono-14")
#+end_src
